...
import 'package:omg1/shared/components/default_form_field.dart';
      ...
      child: BlocConsumer<AppCubit, AppStates>(
          ...
          builder: (context, state) {
            ...
            return Scaffold(
              ...
              backgroundColor: Color.fromARGB(255, 94, 59, 12),
              key: scaffoldKey,
                ...
                onPressed: () {
                  if (cubit.isBottomSheetShown) {
                    ...
                    scaffoldKey.currentState!
                                    ...
                                    children: [
                                      Container(
                                        decoration: BoxDecoration(
                                          ...
                                          color: Color.fromARGB(153, 119, 181, 189),
                                        ),
                                        height: 50,
                                        child: Center(
                                            child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'Add Task',
                                              style: TextStyle(
                                                  color: Color.fromARGB(255, 141, 192, 46),
                                                  fontSize: 16,
                        ...
                        .then((value) {
                      cubit.changeBottomSheetState(
                          false, Icon(Icons.edit_note, color: Colors.white));
                    });
